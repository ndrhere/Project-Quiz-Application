const data = {
    ...
    let startQuiz= ()=>{
       ...
       document.getElementById('questiondata').innerHTML = ` ${index+1}. ${data.coding[index].question}`
       document.getElementById('option1').nextElementSibling.innerHTML= data.coding[index].options[0]
       document.getElementById('option2').nextElementSibling.innerHTML= data.coding[index].options[1]
       document.getElementById('option3').nextElementSibling.innerHTML= data.coding[index].options[2]
       document.getElementById('option4').nextElementSibling.innerHTML= data.coding[index].options[3]
    ...
    console.log(right, wrong)
       ...
       if (index===data.coding.length-1){
        console.log("Index is equal to data.coding.length");
    ...
    //    let userData = localStorage.setItem(`UserAnswer for Q.${index+1}, ${optionSelected.id}`)
        ...
        let submit = ()=>{
            let index = data.coding.length-1;
            let rightAnswer = data.coding[index].answer
