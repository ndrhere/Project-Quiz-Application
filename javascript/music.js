...
let startQuiz= ()=>{
   ...
   document.getElementById('questiondata').innerHTML = ` ${index+1}. ${data.music[index].question}`
   document.getElementById('option1').nextElementSibling.innerHTML= data.music[index].options[0]
   document.getElementById('option2').nextElementSibling.innerHTML= data.music[index].options[1]
   document.getElementById('option3').nextElementSibling.innerHTML= data.music[index].options[2]
   document.getElementById('option4').nextElementSibling.innerHTML= data.music[index].options[3]
...
//    let userData = localStorage.setItem(`UserAnswer for Q.${index+1}, ${optionSelected.id}`)
    ...
    let submit = ()=>{
        let index = data.music.length-1;
        let rightAnswer = data.music[index].answer
